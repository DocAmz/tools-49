  ...
  return (
    <div className="flex items-center justify-between border-b px-4 py-2">
      <div className="flex items-center space-x-4">
        <h1 className="text-lg font-semibold">Font Inspector</h1>
        {loading && (
      ...
      <div className="flex items-center space-x-2">
        ...
        <Button variant="outline" size="icon" onClick={onDownload}>
          ...
          <span className="sr-only">Download Font</span>
        </Button>
        <Button variant="outline" size="icon" onClick={onEdit}>
          <Edit className="h-4 w-4" />
          <span className="sr-only">Edit Font</span>
        </Button>
        <Button variant="outline" size="icon" onClick={onClear}>
          <Trash className="h-4 w-4" />
          <span className="sr-only">Clear Font</span>
        </Button>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem>Export as OTF</DropdownMenuItem>
            <DropdownMenuItem>Export as WOFF</DropdownMenuItem>
            <DropdownMenuItem>Export as WOFF2</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    </div>
